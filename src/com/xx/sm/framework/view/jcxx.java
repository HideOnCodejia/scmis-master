...
public class jcxx extends JFrame {
   ...
   /* JLabel jb1 = new JLabel("学号");
    ...
    public jcxx(String sno){
        JLabel xuehao = new JLabel("学号");
        JLabel name = new JLabel("奖励等级");
        JLabel ssex = new JLabel("奖励时间");
        JLabel brithday = new JLabel("奖励内容");
        ...
        try {
            while (rs2.next()) {
                ...
                j2.setText(rs2.getString("Rlevel"));
                j3.setText(rs2.getString("Rtime"));
                j4.setText(rs2.getString("Rmeno"));
            }
